...
- Use this page as the authoritative reference for **Writing Your First End To End Test**.
...
Reference: https://docs.cypress.io/app/end-to-end-testing/writing-your-first-end-to-end-test
