...
- Use this page as the authoritative reference for **Okta Authentication**.
...
Reference: https://docs.cypress.io/app/guides/authentication-testing/okta-authentication
