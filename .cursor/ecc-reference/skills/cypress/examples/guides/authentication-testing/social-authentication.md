...
- Use this page as the authoritative reference for **Social Authentication**.
...
Reference: https://docs.cypress.io/app/guides/authentication-testing/social-authentication
