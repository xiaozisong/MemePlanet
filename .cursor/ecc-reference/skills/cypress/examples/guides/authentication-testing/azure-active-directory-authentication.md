...
- Use this page as the authoritative reference for **Azure Active Directory Authentication**.
...
Reference: https://docs.cypress.io/app/guides/authentication-testing/azure-active-directory-authentication
