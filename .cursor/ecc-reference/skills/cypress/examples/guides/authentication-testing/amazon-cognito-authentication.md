...
- Use this page as the authoritative reference for **Amazon Cognito Authentication**.
...
Reference: https://docs.cypress.io/app/guides/authentication-testing/amazon-cognito-authentication
